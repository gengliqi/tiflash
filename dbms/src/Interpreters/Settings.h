...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, grpc_completion_queue_size, 0, "The size of gRPC completion queue pool. 0 means using hardware_concurrency.")                                                                                                 \
    M(SettingUInt64, grpc_thread_per_queue_size, 1, "The size of gRPC completion queue pool. 0 means using hardware_concurrency.")                                                                                                 \
    ...
    M(SettingBool, new_hash_join_enable_build_prefetch, true, "")
