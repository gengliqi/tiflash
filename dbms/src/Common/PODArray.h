...
public:
    ...
    SimplePaddedPODArray(SimplePaddedPODArray && other) noexcept
    ...
    void swap(SimplePaddedPODArray & other) noexcept
    {
    ...
    void deserializeAndInsertFromPos(PaddedPODArray<UInt8 *> & pos)
    {
