...
public:
    ...
    {
        return reinterpret_cast<const PODArrayTemplate<ELEMENT_SIZE, 4096, Allocator<false>, 15, 16> *>(
    ...
    {
        return reinterpret_cast<PODArrayTemplate<ELEMENT_SIZE, 4096, Allocator<false>, 15, 16> *>(
