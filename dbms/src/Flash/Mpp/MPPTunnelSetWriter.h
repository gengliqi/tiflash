...
public:
    ...
    void partitionWrite(const Block & header, std::vector<IColumn::ScatterColumns> & scattered, int16_t partition_id, MPPDataPacketVersion version, CompressionMethod compression_method);
    ...
    UInt64 getTimeToWrite() { return time_to_write; }
